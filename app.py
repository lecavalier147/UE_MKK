...
with tab2:
    ...
    with col_left:
        ...
        # Матрица ретеншн (предустановленная)
    ...
    if calc_btn:
        # Собираем параметры из session_state (добавлены early_rate)
        params_new = {
            ...
            'early_rate': st.session_state.get('early_new', 0.15),
        ...
        params_repeat = {
            ...
            'early_rate': st.session_state.get('early_rep', 0.10),
